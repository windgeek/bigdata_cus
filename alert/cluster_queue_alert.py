...
ResourceManagerMap = {}
ResourceManagerMap['rm1'] = "192.168.xx.xx"
ResourceManagerMap['rm2'] = "192.168.xx.xx"
ResourceManagerUrl = "192.168.xx.xx"
queue_per = 95
try:
...
APPLICATION_MASTER = "http://%s:8088/ws/v1/cluster/scheduler" % ResourceManagerUrl
